...
The history itself is stored in an SQLite database within the application, using androids Room abstraction layer[SOURCE]. This allows persistent storage between sessions and offers an intuitive way for the developer to access structured data through SQL queries.

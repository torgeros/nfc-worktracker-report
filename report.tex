...
Additionally, it was mentioned that the color scheme of the app is not perfect. I took that problem into consideration already, but did not implement it until after the testing was done. The latest version of the app does support Android's system-wide Material You design scheme. %TODO footnote and typo check
